...
BOARD_SUPER_PARTITION_SIZE := 5507596288
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3825680384
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 1073741824
BOARD_SUPER_PARTITION_OEM_DEVICE_SIZE := 608174080
BOARD_SUPER_PARTITION_BLOCK_DEVICES := system vendor oem
BOARD_SUPER_PARTITION_METADATA_DEVICE := system
BOARD_SUPER_PARTITION_GROUPS := somc_dynamic_partitions
BOARD_SOMC_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_ext vendor
BOARD_SOMC_DYNAMIC_PARTITIONS_SIZE := 5503401984 # (BOARD_SUPER_PARTITION_SIZE - 4194304) 4MiB overhead
